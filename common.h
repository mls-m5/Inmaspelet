...
#define debug_print(...) __android_log_print(ANDROID_LOG_INFO, "rymbden", __VA_ARGS__)
#define debug_write(...) __android_log_write(ANDROID_LOG_INFO, "rymbden", __VA_ARGS__)
